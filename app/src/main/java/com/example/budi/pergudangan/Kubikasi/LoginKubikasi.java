...
public class LoginKubikasi extends AppCompatActivity {
    ...
    private String url = Server.URLK + "login.php";
    private static final String TAG = LoginKubikasi.class.getSimpleName();
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    public final static String TAG_ID = "id_kubikasi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_kubikasi);
    ...
    public void register(View v) {
        Intent intent = new Intent(getApplicationContext(), RegisterKubikasi.class);
        startActivity(intent);
    }
